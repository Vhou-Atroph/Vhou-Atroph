...
#Idle animations
{'idle':'phase_5/models/char/suitA-throw-object.bam'})
cog.loop('idle')
cog.setH(180)
...
cog.find('**/hands').setColor(cogHands.pp)#This sets LLC's hand color to be that of all bossbots, stored in cogHands.py

#Head model
head=loader.loadModel('phase_4/models/char/suitA-heads.bam').find('**/pennypincher')
