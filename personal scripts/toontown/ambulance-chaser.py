...
#Idle animations
{'idle':'phase_5/models/char/suitB-walknreach.bam'})
cog.loop('idle')
cog.setH(180)
...
cog.find('**/hands').setColor(cogHands.legalPolyColor)#these comments henceforth will be inaccurate lol

#Head model
head=loader.loadModel('phase_4/models/char/suitB-heads.bam').find('**/ambulancechaser')
