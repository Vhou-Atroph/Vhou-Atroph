...
#Idle animations
{'idle':'phase_5/models/char/suitB-magic3.bam'})
cog.loop('idle')
cog.setH(180)
...
cog.find('**/hands').setColor(cogHands.sd)#these comments henceforth will be inaccurate lol

#Head model
head=loader.loadModel('phase_4/models/char/suitB-heads.bam').find('**/telemarketer')
head.reparentTo(cog.find('**/joint_head'))
headTex=loader.loadTexture('phase_4/maps/spin-doctor.jpg')
