...
#Idle animations
{'idle':'phase_5/models/char/suitC-speak.bam'})
cog.loop('idle')
cog.setH(180)
...
#Head model
head=loader.loadModel('phase_3.5/models/char/suitC-heads.bam').find('**/flunky')
head.reparentTo(cog.find('**/joint_head'))
headTex=loader.loadTexture('phase_3.5/maps/corporate-raider.jpg')
