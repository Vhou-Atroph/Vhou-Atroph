...
#Idle animations
{'idle':'phase_4/models/char/suitC-victory.bam'})
cog.loop('idle')
cog.setH(180)
...
#Head model
flunkyHead=loader.loadModel('phase_3.5/models/char/suitC-heads.bam').find('**/flunky')
flunkyGlasses=loader.loadModel('phase_3.5/models/char/suitC-heads.bam').find('**/glasses')
flunkyHead.reparentTo(cog.find('**/joint_head'))
flunkyGlasses.reparentTo(cog.find('**/joint_head'))
